...
<div class="col-md-7">
            ...
            <div class="post-content">
              <img src='<c:url value="resources/images/post-images/1.jpg"></c:url>' alt="post-image" class="img-responsive post-image" />
              <div class="post-container">
                <img src='<c:url value="resources/images/users/user-5.jpg"></c:url>' alt="user" class="profile-photo-md pull-left" />
                <div class="post-detail">
                  ...
                  <div class="post-comment">
                    <img src='<c:url value="resources/images/users/user-11.jpg"></c:url>' alt="" class="profile-photo-sm" />
                    <p><a href="timeline.html" class="profile-link">Diana </a><i class="em em-laughing"></i> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud </p>
                  </div>
                  <div class="post-comment">
                    <img src='<c:url value="resources/images/users/user-4.jpg"></c:url>' alt="" class="profile-photo-sm" />
                    <p><a href="timeline.html" class="profile-link">John</a> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud </p>
                  </div>
                  <div class="post-comment">
                    <img src='<c:url value="resources/images/users/user-1.jpg"></c:url>' alt="" class="profile-photo-sm" />
